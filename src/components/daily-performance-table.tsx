...
{ key: "todayAppointments", label: "Today Appointments", group: "meetings", dataKey: "todayAppointments" },
  {
    key: "todayAppointmentsPct",
    label: "Today Appointments %",
    group: "meetings",
    isPercent: true,
    compute: (r) => r.totalPositiveReplies > 0 ? (r.todayAppointments / r.totalPositiveReplies) * 100 : 0,
  },
  { key: "bookings", label: "Bookings", group: "meetings", dataKey: "bookings" },
  { key: "meetingsShowUp", label: "Showed Up", group: "meetings", dataKey: "meetingsShowUp" },
  {
    ...
    group: "meetings",
    isPercent: true,
    compute: (r) => r.todayAppointments > 0 ? (r.meetingsShowUp / r.todayAppointments) * 100 : 0,
  },
  ...
  { key: "meetingsNoShow", label: "No-Show", group: "meetings", dataKey: "meetingsNoShow" },
  {
    ...
    group: "meetings",
    isPercent: true,
    compute: (r) => r.todayAppointments > 0 ? (r.meetingsNoShow / r.todayAppointments) * 100 : 0,
  },
